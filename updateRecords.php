        ...
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                ...
                <form class="mx-1 mx-md-4" method="POST">
                    ...
                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Update Record</p>
                    ...
                    if (array_key_exists('submit', $_POST)) {
                        ...
                        $updateId = "update patient p,registration r set r.name='$name', r.email='$email' , r.address='$address' , p.problem='$problem',r.phone='$contact' where r.r_id=p.r_id and p.p_id='$id' ";
