                ...
                <form method="POST">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline  mb-0">
                            <label class="form-label" for="form3Example1c">Enter Doctors Id You Want to Delete</label>
                            <input type="number" id="form3Example1c" class="form-control" name="id" required /><br>
                            <button type="submit" class="btn btn-danger" id='delete-record' name="submit">Delete
                                Record</button>
