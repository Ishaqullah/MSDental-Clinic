...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row flex-nowrap">
            ...
            $fetchQuery = "SELECT  a.date as 'date',sum(s.fees) as 'rev' FROM appointment a, services s ,medicalhistory m WHERE a.A_Id=m.A_Id and s.S_ID=m.S_id GROUP by a.Date";
